$(document).ready(function() {
  ...
  Mousetrap.bind('ctrl e c', function(e) {
    ...
    if (frm) {
        ...
        document.getElementById('searchform').action = "http://localhost:3000/manage-participant/screening-history-a-notes";
        return false;
    } else {
        window.location.href = "http://localhost:3000/manage-participant/screening-history-a-notes";
    }
  });
  ...
  Mousetrap.bind('ctrl c y', function(e) {
    ...
    if (frm) {
        document.getElementById("searchfield").focus();
        document.getElementById('searchform').action = "http://localhost:3000/manage-participant/screening-history-a#testresults";
        return false;
    } else {
        window.location.href = "http://localhost:3000/manage-participant/screening-history-a#testresults";
    }
  });
