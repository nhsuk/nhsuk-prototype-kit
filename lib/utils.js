...
exports.autoStoreData = function (req, res, next) {
  ...
  // Add errors to views in the same place as data is added
  if (req.session.errors) {
    const { errorsList, errorsObj } = req.session.errors;
    res.locals.errorsList = errorsList;
    res.locals.errorsObj = errorsObj;
