...
import customFilters from '../app/filters.js'
...
let sessionDataDefaultsPromise
try {
  sessionDataDefaultsPromise = import(sessionDataDefaultsFile).then(module => {
    sessionDataDefaults = module.default
  ...
  console.error(error)
  sessionDataDefaultsPromise = Promise.resolve({})
}
